      ...
      <CartStyled onClick={e => e.stopPropagation()}>
        ...
        {cart.cartItems.length > 0 &&
          <Footer>
            ...
            {!isAuthenticated
                  ? <Link to='/my-account/login' onClick={() => toggleSideCart()}><button className='checkout-btn'>view cart</button></Link>
                  : <Link to='/cart' onClick={() => toggleSideCart()}><button className='checkout-btn'>view cart</button></Link>
                }
              <div>
